...
namespace ProjectMeasurementTest
{
    public class UserShould
    {
        ...
        public UserShould()
        {
            ...
            optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=CustomProjectTestAgain;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        }
